...
// 本样例展示百炼在线Fun-ASR实时语音识别使用方法
// Android SDK 详细说明：
public class DashFunAsrSpeechTranscriberActivity extends Activity implements INativeNuiCallback, AdapterView.OnItemSelectedListener {
    private static final String TAG = "FunAsrST";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(DashFunAsrSpeechTranscriberActivity.this,
    ...
    private void getSampleRateList() {
        ...
        ArrayAdapter<String> spinnerSR = new ArrayAdapter<String>(
                DashFunAsrSpeechTranscriberActivity.this,
    ...
    private void getModelList() {
        ...
        model.add("fun-asr-realtime");
        model.add("fun-asr-realtime-2025-09-15");
...
//            object.put("apikey", g_apikey);
    ...
    public void onNuiEventCallback(Constants.NuiEvent event, final int resultCode,
        ...
        if (event == Constants.NuiEvent.EVENT_TRANSCRIBER_STARTED) {
            ...
            showText(asrView, "EVENT_SENTENCE_START");
